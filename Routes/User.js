    ...
    try {
       ...
       const Name = randomstring.generate({
        ...
        if (user != null)
        {
           ...
           https.get(`https://www.fast2sms.com/dev/bulkV2?authorization=YzwWibBm3yLudgfAGl2nqKXekrtS57Hph8cVaM46oRT9QDvJUIS23HipxvhzIYM7sEVGCb51LDWfKO68&route=dlt&sender_id=WPISMS&message=148262&variables_values=${newSecret.token}%7C&flash=0&numbers=${Phone}`, (resp) => {
                console.log("send");
            })
...
router.post("/login/admin", async (req, res) => {
    ...
    try {
      ...
      let otpmobile = '8619240514';
      user.otp = newSecret.token;
      user.save();
  
            
        https.get(`https://www.fast2sms.com/dev/bulkV2?authorization=YzwWibBm3yLudgfAGl2nqKXekrtS57Hph8cVaM46oRT9QDvJUIS23HipxvhzIYM7sEVGCb51LDWfKO68&route=dlt&sender_id=WPISMS&message=148262&variables_values=${newSecret.token}%7C&flash=0&numbers=${otpmobile}`, (resp) => {
                console.log("send");
            })
